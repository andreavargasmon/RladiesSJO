...
#En algunas ocaciones el orden de los elementos dentro de un vector que fun convertido en factor no importa pero en este caso vamos a asignarle nombre a los elementos dentro de él según el orden que indica el vector. 
